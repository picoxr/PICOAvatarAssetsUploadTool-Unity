pwd
xattr -r -d com.apple.quarantine ../../CustomPackages/PICOUnityAvatarSDK-2.0.0/Editor/Plugins/OSX/libs/libassimp.5.dylib
xattr -r -d com.apple.quarantine ../../CustomPackages/PICOUnityAvatarSDK-2.0.0/Editor/Plugins/OSX/libs/libavatarloader.dylib
