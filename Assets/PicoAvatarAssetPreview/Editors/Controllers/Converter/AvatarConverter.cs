...
namespace Pico
{
    namespace AvatarAssetPreview
    {
        ...
        {
            public static string converterRootDir { get => "Assets/PicoAvatarAssetPreview/Editors/Controllers/Converter"; }
            public static string builtinSkeletonPath { get => Application.dataPath + "/PicoAvatarAssetPreview/Assets/Resources/PavOfficial_1_0_MaleSkeleton.zip"; }
            private static string builtinAnimPath { get => Application.dataPath + "/PicoAvatarAssetPreview/Assets/Resources/PavOfficial_1_0_MaleAnim.zip"; }
