...
namespace Pico
{
    namespace AvatarAssetPreview
    {
        public class WarningPanel : PavPanel
        {
            ...
            {
                // uxml路径
                public override string AssetPath => "Assets/PicoAvatarAssetPreview/Editors/Views/UxmlWidget/WarningPanel.WarningTemplate.uxml";
                private Label name;
            ...
            {
                // uxml路径
                public override string AssetPath => "Assets/PicoAvatarAssetPreview/Editors/Views/UxmlWidget/WarningPanel.ErrorTemplate.uxml";
                private Label name;
