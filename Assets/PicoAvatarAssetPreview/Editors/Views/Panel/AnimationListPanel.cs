            ...
            request.Send(success =>
                {
                    ...
                    else
                    {
                        ...
                        if (MainMenuUIManager.instance.PAAB_OPEN == false)
                        {
                            ...
                            localAnimationAssetData.asset_info.status = AvatarAssetPreviewConst.PseudoLocalState;
...
#region UIEvent
    ...
    public class AnimationSetAssetCell : PavScrollViewCell
    {
        ...
        public override string AssetPath => "Assets/PicoAvatarAssetPreview/Editors/Views/UxmlWidget/AnimationSetAssetCell.uxml";
    ...
    public class AnimtionTestCell : PavScrollViewCell
    {
        ...
        public override string AssetPath => "Assets/PicoAvatarAssetPreview/Editors/Views/UxmlWidget/AnimationTestCell.uxml";
