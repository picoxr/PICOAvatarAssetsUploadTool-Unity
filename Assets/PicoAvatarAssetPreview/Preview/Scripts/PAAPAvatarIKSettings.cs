...
namespace AssemblyCSharp.Assets.AmzAvatar.TestTools
{
    ...
    /// </summary>
    public class PAAPAvatarIKSettings : MonoBehaviour
    {
        /// <summary>
        /// IK target settings
        /// </summary>
        ...
        /// <summary>
        /// Copy the PAAPAvatarIKSettings object
        /// </summary>
        /// <param name="from">The input PAAPAvatarIKSettings object</param>
        /// <param name="to">The ouput PAAPAvatarIKSettings object</param>
        public static void Copy(PAAPAvatarIKSettings from, PAAPAvatarIKSettings to)
        {
        ...
        public void updateIKTargetsConfig(AvatarIKTargetsConfig ikTarget)
        {
            ...
            // In editor mode, always use the targets from EditorInputDevice.
#if !UNITY_EDITOR
        ...
        /// <summary>
        /// Whether this instance of 'AvatarIKSettings' has been modified
        /// </summary>
