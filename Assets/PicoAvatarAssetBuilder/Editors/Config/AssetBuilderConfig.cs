...
namespace Pico
{
    namespace AvatarAssetBuilder
    {
        ...
        public class AssetBuilderConfig
        {
            ...
            public string uiDataAssetsPath { get => "Assets/PicoAvatarAssetBuilder/Editors/Views/"; }

            public string uiDataStorePath { get => "Assets/PicoAvatarAssetBuilder/Models/"; }

            public string uiDataIconPath { get => "Assets/PicoAvatarAssetBuilder/Assets/Icon"; }

            public string uiDataEditorConfigPath { get => "Assets/PicoAvatarAssetBuilder/Editors/Config/"; }

            public string uiDataAssetUssPath { get => "Assets/PicoAvatarAssetBuilder/Assets/Uss/"; }

            // data path for asset viwer. default as "Assets/PicoAvatarAssetBuilder/Models"
            public string assetViwerDataAssetsPath
            {
                get
                {
                    if (string.IsNullOrEmpty(_assetViwerDataAssetsPath))
                    {
                        ...
                        if (string.IsNullOrEmpty(_assetViwerDataAssetsPath))
                        {
                            _assetViwerDataAssetsPath = "Assets/PicoAvatarAssetBuilder/Models/";
                        }
                    }
            ...
            // data path for asset viewer. default as "Assets/PicoAvatarAssetBuilder/Scenes/AssetViewer/AssetViewer.unity"
