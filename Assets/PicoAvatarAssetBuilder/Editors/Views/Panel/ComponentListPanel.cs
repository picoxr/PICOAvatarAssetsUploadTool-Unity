            ...
            request.Send(success =>
                {
                    ...
                    else
                    {
                        ...
                        if (MainMenuUIManager.instance.PAAB_OPEN == false)
                        {
                            ...
                            localComponentAssetData.asset_info.status = AvatarAssetBuilderConst.PseudoLocalState;
...
#region UIEvent
    ...
    public class SubElementCell : PavScrollViewCell
    {
        ...
        private VisualElement line;
        private SimpleButtonToggle toggle;
        public override string AssetPath => "Assets/PicoAvatarAssetBuilder/Editors/Views/UxmlWidget/ComponentListSubMenuCell.uxml";
    ...
    public class ComponentAssetCell : PavScrollViewCell
    {
        ...
        public override string AssetPath => "Assets/PicoAvatarAssetBuilder/Editors/Views/UxmlWidget/ComponentAssetCell.uxml";
    ...
    public class CreateComponentAssetCell : PavScrollViewCell
    {
        ...
        public override string AssetPath => "Assets/PicoAvatarAssetBuilder/Editors/Views/UxmlWidget/CreateNewComponentCell.uxml";
