                ...
                foreach (var info in data.characters)
                {
                    if (MainMenuUIManager.instance.PAAB_OPEN == false)
                    {
                        ...
                        else if (manager.avatarName == CharacterUtil.NewCharacterTempName)
                        {
                            ...
                            cellData.characterData.character.status = AvatarAssetBuilderConst.PseudoLocalState;
...
#region 滑动列表
        ...
        {
            public override string AssetPath => "Assets/PicoAvatarAssetBuilder/Editors/Views/UxmlWidget/CharacterCell.uxml";
            ...
            public override void RefreshCell()
            {
                ...
                localIcon.SetActive(data.characterData.character.status == AvatarAssetBuilderConst.PseudoLocalState); // 已发布
