    ...
    namespace AvatarAssetBuilder
    {
        ...
        public class AssetViewerStarter
        {
            ...
            public static void StartAssetViewer(PaabAssetImportSettings assetSettings)
            {
                ...
                // 2. save start data. "Assets/PicoAvatarAssetBuilder/Models/Data/AssetViewerStartData.asset"
                ...
                // 7. start enter viewer in playing mode. "Assets/PicoAvatarAssetBuilder/Scenes/AssetViewer/AssetViewer.unity"
                EditorSceneManager.OpenScene(AssetBuilderConfig.instance.assetViewerScenePath);
